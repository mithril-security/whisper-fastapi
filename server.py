...
TEE_ENV: t.Literal["nitriding", "sev-aci"] = os.environ.get("TEE_ENV", "nitriding")
if TEE_ENV not in ["nitriding", "sev-aci"]:
    raise ValueError(f"Invalid TEE_ENV environment variable: {TEE_ENV}")
OPENCHATKIT_ENABLED = TEE_ENV != "sev-aci"
